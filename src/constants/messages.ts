...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  en: {
    ...
    comparisonTitle: "SPEC{0} Performance comparison",
    comparisonDataset: "Dataset",
    comparisonSourceA: "Baseline (A)",
    comparisonSourceB: "Comparison (B)",
  ...
  zh: {
    ...
    noData: "当前筛选范围内无数据",
    tabsCompare: "性能对比",
    comparisonTitle: "SPEC{0}性能对比",
    comparisonDataset: "数据集",
    comparisonSourceA: "基线 (A)",
    comparisonSourceB: "对比 (B)",
